...
const popupTypeNewCard = document.querySelector('.popup__type_new-card');
const popupTypeImage = document.querySelector('.popup__type_image');
const popupTypeContentUsers = document.querySelector('.popup__type_content-users');
