...
const popupTypeEdit = document.querySelector('.popup__edit');
const popupTypeNewCard = document.querySelector('.popup__new-card');
const popupTypeImage = document.querySelector('.popup__new-image');
const popupTypeContentUsers = document.querySelector('.popup__content-users');
